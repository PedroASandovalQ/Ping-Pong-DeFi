...
exports.decimals = exports.opfAssets = exports.underlyings = exports.cTokens = exports.abi = exports.address = exports.constants = exports.cometConstants = void 0;
var _cometConstants = require("./comet-artifacts/comet-constants.json");
...
exports.cometConstants = _cometConstants;
...
var cometNetworks = Object.keys(_cometConstants.address);
cometNetworks.forEach(function (network) {
    var contractNames = Object.keys(_cometConstants.address[network]);
    contractNames.forEach(function (contract) {
        if (!exports.address[network]) {
            exports.address[network] = {};
        }
        var value = _cometConstants.address[network][contract];
        if (typeof value === 'string') {
            exports.address[network][contract] = value;
        }
        else if (typeof value === 'object' && value.contract && typeof value.contract === 'string') {
            exports.address[network][contract] = value.contract;
        }
    });
});
exports.abi = {
    ...
    Comet: exports.cometConstants.abi
};
exports.cTokens = [
    'cAAVE',
    'cBAT',
